...
public class Panel extends JPanel implements Runnable, KeyListener {
    ...
    private final static int FRECUENCIA_ENEMIGOS_LEVEL1 = 200;
    private final static int FRECUENCIA_ENEMIGOS_LEVEL2 = 100;
    private final static int FRECUENCIA_ENEMIGOS_LEVEL3= 50;
